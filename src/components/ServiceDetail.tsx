      ...
      <main>
        ...
        <section className="bg-light py-20">
          <div className="max-w-3xl mx-auto px-6 lg:px-8 text-center">
            ...
            <a
              href="tel:+4552721102"
              className="inline-flex items-center gap-3 bg-accent hover:bg-yellow-600 text-primary font-bold text-2xl px-10 py-5 rounded-full transition-all duration-300 shadow-xl hover:scale-105"
            >
