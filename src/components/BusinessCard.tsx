      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-8 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <a href="mailto:hello@wicare.vip" className="flex flex-col items-center justify-center gap-2 border-2 border-primary text-primary hover:border-accent hover:text-accent-dark py-5 rounded-2xl transition-colors">
