...
export const services: Service[] = [
  ...
  },
  {
    ...
    description: 'Expert gardening, construction, and handyman services. Skilled professionals for every property need — from rooftop terraces to basement renovations.',
    longDescription: 'WiHelp connects you with vetted professionals for every property need. From landscaping and garden design to construction projects and handyman repairs, our skilled tradespeople deliver the same standard of excellence that defines every WiCare brand. No more chasing contractors — one call handles it all.',
    features: ['Landscaping & gardening', 'Construction projects', 'Handyman services', 'Property maintenance', 'Seasonal preparation', 'Project management'],
    details: ['Vetted, licensed professionals', 'Full project management from concept to completion', 'Same-day service for urgent repairs', 'Transparent, fixed-price quotes'],
  },
  {
    slug: 'wi-shine',
    name: 'WiShine',
  ...
  },
  {
    ...
    description: 'Premium walks with full hygiene care. Paws wiped, water refreshed, and a photo update sent straight to your phone.',
    longDescription: 'WiPet treats your dog with the same care you would. Our pet valets arrive for a brisk walk in the neighborhood or adjacent trails, using secure harnesses and GPS-tracked routes. After the walk, paws are wiped with natural-fiber wipes to protect your floors, the water bowl is refreshed, and a high-quality photo is sent to your phone. Proof of life, every time.',
    features: ['Brisk neighborhood walk', 'Paw wiping & hygiene', 'Hydration refill', 'Photo proof of life', 'GPS-tracked routes', 'Secure harness (no collar)'],
    details: ['20-30 minute walks in upscale neighborhoods', 'Natural-fiber paw wipes — safe for pets and floors', 'Automated SMS update after every walk', 'Always high-quality harness — never just a collar'],
  },
  {
    slug: 'wi-garden',
    name: 'WiGarden',
    subtitle: 'Architectural Botanical Care',
    description: 'Expert care for luxury indoor plants. Leaf dusting, soil moisture checks, precision watering, dead leaf removal, and rotation for even sunlight.',
    longDescription: 'WiGarden keeps your architectural plants thriving. Luxury homes feature expensive, large-scale greenery — fiddle leaf figs, monsteras, orchids — that standard cleaners avoid and specialist plant services charge a premium for. WiGarden bridges that gap, providing expert care: gentle leaf dusting, moisture meter checks to prevent root rot, precision watering, dead leaf removal with sterilized shears, and 90-degree pot rotation for even growth.',
    features: ['Leaf dusting & cleaning', 'Moisture meter check', 'Precision watering', 'Aesthetic pruning', 'Pot rotation', 'Plant health assessment'],
    details: ['Professional moisture meter — never guess', 'Sterilized pruning shears for every cut', '90-degree rotation for even sunlight', 'Monthly plant health report'],
  },
]
