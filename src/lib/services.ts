...
export const services: Service[] = [
  ...
  },
  {
    ...
    longDescription: 'WiPaws treats your dog with the same care you would. Our pet valets arrive for a brisk walk in the neighborhood or adjacent trails, using secure harnesses and GPS-tracked routes. After the walk, paws are wiped with natural-fiber wipes to protect your floors, the water bowl is refreshed, and a high-quality photo is sent to your phone. Proof of life, every time.',
  ...
  },
  {
    ...
    longDescription: 'WiGreen keeps your architectural plants thriving. Luxury homes feature expensive, large-scale greenery — fiddle leaf figs, monsteras, orchids — that standard cleaners avoid and specialist plant services charge a premium for. WiGreen bridges that gap, providing expert care: gentle leaf dusting, moisture meter checks to prevent root rot, precision watering, dead leaf removal with sterilized shears, and 90-degree pot rotation for even growth.',
