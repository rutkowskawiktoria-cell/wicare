...
export const services: Service[] = [
  ...
  },
  {
    ...
    details: ['On-site service without drop-off needed', 'Waterless technology for zero mess', 'Premium Saphir leather care products', 'Concurrent with WiClean or WiHelp visit'],
  },
  {
    slug: 'wi-wardrobe',
    name: 'WiWardrobe',
  ...
  },
  {
    ...
    details: ['Premium fragrance brands marked up 30-50%', 'Seasonal rotation for fresh scents', '5-minute touch-up during any visit', 'Personalized fragrance profile per room'],
  },
  {
    slug: 'wi-device',
    name: 'WiDevice',
