...
export const services: Service[] = [
  {
    ...
    details: ['Serving the northern suburbs\' most discerning clients since 2016', 'Thoughtfully selected products balanced for safety and efficacy', 'Flexible scheduling for mornings, evenings, weekends', 'Dedicated team assigned to your property'],
    highlight: true,
  },
  {
    slug: 'la-table',
    ...
    longDescription: 'La Table brings Michelin-star and Danish Parliament culinary expertise directly to your home. Our chefs have cooked for heads of state, royalty, and the most demanding palates in the northern suburbs of Copenhagen. Whether it is an intimate dinner for two, a boardroom lunch, or a grand celebration, every dish is crafted with precision, creativity, and world-class technique.',
